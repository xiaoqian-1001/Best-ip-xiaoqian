...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///workspace/byoip-ui/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, join, dirname } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///workspace/byoip-ui/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///workspace/byoip-ui/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///workspace/byoip-ui/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import * as net from 'node:net';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///workspace/byoip-ui/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///workspace/byoip-ui/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///workspace/byoip-ui/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///workspace/byoip-ui/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///workspace/byoip-ui/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///workspace/byoip-ui/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///workspace/byoip-ui/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///workspace/byoip-ui/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///workspace/byoip-ui/node_modules/unstorage/drivers/fs.mjs';
import { mkdir, writeFile, rename, unlink, readFile } from 'node:fs/promises';
import fsDriver from 'file:///workspace/byoip-ui/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///workspace/byoip-ui/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///workspace/byoip-ui/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///workspace/byoip-ui/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///workspace/byoip-ui/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///workspace/byoip-ui/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///workspace/byoip-ui/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///workspace/byoip-ui/node_modules/radix3/dist/index.mjs';
import consola, { consola as consola$1 } from 'file:///workspace/byoip-ui/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///workspace/byoip-ui/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///workspace/byoip-ui/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///workspace/byoip-ui/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///workspace/byoip-ui/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///workspace/byoip-ui/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///workspace/byoip-ui/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///workspace/byoip-ui/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///workspace/byoip-ui/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///workspace/byoip-ui/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///workspace/byoip-ui/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///workspace/byoip-ui/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/workspace/byoip-ui/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspace/byoip-ui","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspace/byoip-ui/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', cacheDriver({"base":"/workspace/byoip-ui/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspace/byoip-ui/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspace/byoip-ui/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/workspace/byoip-ui/.data/kv"}));
...
const rootDir = "/workspace/byoip-ui";
...
const _wQKxQbEV6toKFcsGuOCHVvjtfJMjkUeP1eihtC3deQ = (nitroApp) => {
...
const plugins = [
  _wQKxQbEV6toKFcsGuOCHVvjtfJMjkUeP1eihtC3deQ,
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"1b579-Y979AtAQOUngkVGuq6xl+05xzBg\"",
    "mtime": "2026-08-02T08:38:43.381Z",
    "size": 111993,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"6ea79-FS8gBXmMB/fNKAdiSoMX3LfTFnA\"",
    "mtime": "2026-08-02T08:38:43.381Z",
    "size": 453241,
    "path": "index.mjs.map"
  }
...
const _Qv6dAl = eventHandler((event) => {
...
const _lazy_CGHBvp = () => Promise.resolve().then(function () { return check$1; });
const _lazy_HngVLb = () => Promise.resolve().then(function () { return nodes$1; });
const _lazy_wGtGsO = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _Qv6dAl, lazy: false, middleware: true, method: undefined },
  { route: '/api/check', handler: _lazy_CGHBvp, lazy: true, middleware: false, method: undefined },
  { route: '/api/nodes', handler: _lazy_HngVLb, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_wGtGsO, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_wGtGsO, lazy: true, middleware: false, method: undefined }
];
...
const check = defineEventHandler((event) => {
...
const nodes = defineEventHandler(async () => {
...
const nodes$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: nodes
}, Symbol.toStringTag, { value: 'Module' }));
